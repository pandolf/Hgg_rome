#/castor/cern.ch/user/m/pandolf/Higgs/reduced!/bin/tcsh
# $Id: makeRedNtp.csh,v 1.35 2013/03/12 14:57:54 pandolf Exp $

# change if needed
#set castordir = /castor/cern.ch/user/m/pandolf/Higgs/reduced
set castordir = /store/group/phys_higgs/pandolf/test
#set castordir = /afs/cern.ch/work/p/pandolf/CMSSW_5_2_5/src/Analysis/Higgs
